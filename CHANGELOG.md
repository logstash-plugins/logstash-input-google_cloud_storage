## 0.14.0
 - Feature, update so that unauthenticated client can access public buckets [#23](https://github.com/logstash-plugins/logstash-input-google_cloud_storage/pull/23)
