...
[NOTE]
================================================================================
Attempting to install this plugin may result in an error about bundler could not find compatible versions for gem "mimemagic".
[source,bash]
----------------------------------
...
the bundled Ruby gem'ss instance inside the Logstash's installation `bin/` folder.
